...
func printSyscall(fieldValue string) (string, error) {
	...
	dir, err := os.Getwd()
	if err != nil {
		return "", errors.Wrap(err, "printsyscall: directory lookup failed")
	}
	name, err := AuditSyscallToName(fieldValue, dir)
	if err != nil {
...
func printA0(fieldValue string, sysNum string) (string, error) {
	...
	dir, err := os.Getwd()
	if err != nil {
		return "", errors.Wrap(err, "printA0: directory lookup failed")
	}
	// need to fetch syscall number on this as well ? design decision ?
	name, err := AuditSyscallToName(sysNum, dir)
	if err != nil {
		return "", errors.Wrap(err, "syscall parsing failed")
	}
...
func printA1(fieldValue, sysNum string, a0 int) (string, error) {
	...
	dir, err := os.Getwd()
	if err != nil {
		return "", errors.Wrap(err, "printA1: directory lookup failed")
	}
	// need to fetch syscall number on this as well ? design decision ?
	name, err := AuditSyscallToName(sysNum, dir)
	if err != nil {
...
func printA2(fieldValue, sysNum string, a1 int) (string, error) {
	...
	dir, err := os.Getwd()
	if err != nil {
		return "", errors.Wrap(err, "printA2: directory lookup failed")
	}
	// need to fetch syscall number on this as well ? design decision ?
	name, err := AuditSyscallToName(sysNum, dir)
	if err != nil {
...
func printA3(fieldValue, sysNum string) (string, error) {
	...
	dir, err := os.Getwd()
	if err != nil {
		return "", errors.Wrap(err, "printA3: directory lookup failed")
	}
	// need to fetch syscall number on this as well ? design decision ?
	name, err := AuditSyscallToName(sysNum, dir)
	if err != nil {
